...
2. 문제 추가 버튼을 통해 문제 추가하기 모달을 열 수 있습니다.
3. 해당 버튼을 클릭해서 확장 모드로 문제를 제작할 수 있습니다.
4. `문제 제목` `문제 태그` `객관식 / 주관식` `보기` `이미지`를 작성할 수 있습니다.
5. 문제 작성이 끝나면 `저장하기` 버튼을 클릭해 문제를 생성할 수 있습니다.
...
1. 선택한 문제를 시험 형식으로 풀어볼 수 있습니다.
2. 버튼을 통해 문제 번호를 눌러 해당 문제로 이동할 수 있습니다.
3. 모든 문제를 풀면 “제출” 버튼이 활성화됩니다.

<img width="576" height="378" alt="image" src="https://github.com/user-attachments/assets/10a44d0e-580f-4ad2-a6c4-c21e514b482f" />

1. 시험 결과는 PDF로 저장할 수 있습니다.
2. 태그별 정답률과 오답률을 통해 취약한 태그를 확인할 수 있습니다.
...
1. 암기나 빠른 복습이 필요한 경우, 카드 시험 모드를 활용할 수 있습니다.
2. 문제를 한 문제씩 풀고, 정답을 확인하고, 정답 여부를 스스로 체크하며 빠르게 학습합니다.

<img width="576" height="378" alt="image" src="https://github.com/user-attachments/assets/5a0910cf-7acd-4be8-bfbe-5d57cbc1168e" />

1. 문제 풀이 결과를 그래프로 확인할 수 있습니다.
2. 방금 문제를 다시 풀어볼 수 있습니다.
...
1. 공유할 문제들을 선택해주세요
2. 내보내기 버튼을 통해 `Zip` 파일로 문제들을 내보낼 수 있습니다.
3. 불러오기 버튼을 통해 `Zip` 파일을 선택해 다른 사람들의 문제들을 추가할 수 있습니다.
