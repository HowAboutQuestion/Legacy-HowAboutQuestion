            ...
            <div className="flex flex-col top-0 max-h-[80vh] overflow-y-auto p-4">
                ...
                <div className="mt-4">
                    ...
                    <div className="flex items-center gap-2">
                        <svg className="w-5 h-5 transition duration-75 text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                            <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z" />
                            <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z" />
                        </svg>
                        <p1 className="text-2xl font-bold mb-2"> 대시보드</p1>
                    </div>
                    <p className="mb-4">
                        대시보드는 사용자의 학습 데이터를 기반으로 <strong>오늘의 추천 문제</strong>를 제공합니다.
                        <br />
                        또한, 내가 푼 문제 수, 맞춘 문제 수, 정답률을 한눈에 확인하고, 과거 기록도 조회할 수 있습니다.
                    </p>
                    ...
                    <p className="mb-4">
                        <strong>오늘의 추천 문제</strong>를 통해 자주 틀리거나 새로 생성된 문제를 복습하세요!
                        <br />
                        학습한 문제는 <strong>자주 맞출수록 덜 등장하고, 자주 틀릴수록 더 자주 추천</strong>됩니다.
                    </p>
                    ...
                    <ul className="list-disc list-inside mb-4">
                        <li>
                            <strong>오늘의 학습 기록</strong>: 내가 푼 문제 수, 정답 수, 정답률을 확인할 수 있습니다.
                        </li>
                        <li>
                            <strong>최근 7일 히스토리</strong>: 가장 최근 7일 동안의 학습 기록을 리스트로 제공합니다.
                        </li>
                        <li>
                            <strong>달력 기능 지원</strong>: 특정 날짜를 선택하면 해당 날짜의 학습 기록을 확인할 수 있습니다.
                        </li>
                    </ul>
                    ...
                    <div className="flex items-center gap-2">
                        <svg
                            className="flex-shrink-0 w-5 h-5 transition duration-75 text-blue-500" aria-hidden="true"
                        ...
                        <p1 className="text-2xl font-bold mb-2"> 문제 관리</p1>
                    </div>
                    <p className="mb-4">
                        내가 만든 문제를 한눈에 확인하고, 직접 생성, 수정, 삭제할 수 있는 공간입니다.
                        <br />
                        또한, <strong>문제 가져오기/내보내기 기능</strong>을 통해 다른 사용자의 문제를 활용할 수도 있습니다.
                    </p>
                    ...
                    <p className="mb-4">
                        문제 생성 기능을 통해 <strong>객관식 & 주관식 문제</strong>를 만들 수 있습니다.
                        <br />
                        <strong>태그 기능</strong>을 활용하면 문제를 쉽게 분류할 수 있으며,
                        <br />
                        객관식 문제의 경우 최대 <strong>4개의 선택지</strong>를 설정하고 <strong>정답을 지정</strong>할 수 있습니다.
                        <br />
                    ...
                    <div className="flex items-center gap-2">
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            className="flex-shrink-0 size-6 transition duration-75 text-blue-500" aria-hidden="true"
                        >
