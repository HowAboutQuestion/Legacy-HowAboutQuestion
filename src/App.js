...
class Navbar extends Component {
    ...
    render(){
    return (
        <aside className="fixed top-0 left-0 z-40 w-20 h-full " >
        <div className="h-full px-3 py-4 bg-gray-800">
           <ul className="space-y-2 font-medium">
              <li>
                 <a href="#" className="flex justify-center items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
